...
| Graphic Artist | <ul><li>Once the Project Manager has posted the link:<ul><li>Check your email (the one you used to sign up for GitHub) to accept the collaboration invitation.</li><li>Pull the project from GitHub and create a new branch using NetBeans for your work.</li></ul></li></ul> |
...
| Graphic Artist | <ul><li>Complete the following sections of the user guide based on your work in Week 1 and 2: <br /><ul><li>How to Play the Game</li><li>Frequently Asked Questions (FAQs)<br /><br /></li></ul></li><li>Update the Gantt chart.</li></ul> |
