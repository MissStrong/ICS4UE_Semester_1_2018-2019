...
| create a new set: the combination of all the elements of the two sets | "union" | ∪  |{1, 2, 3} ∪ {2, 3, 4} = {1, 2, 3, 4} |
| create a new set: the combination of all the common elements between two sets | "intersection" | ∩ | {1, 2, 3} ∩ {2, 3, 4} = {2, 3} |
| create a new set: all the elements of a particular set, excluding the common elements between another particular set | "difference", "relative component" | – | {1, 2, 3} – {2, 3, 4} = {1} |
