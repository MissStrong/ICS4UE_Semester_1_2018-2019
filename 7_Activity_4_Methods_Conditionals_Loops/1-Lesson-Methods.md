...
| Other Information | | `public static`: The method is accessible throughout the entire program. <br></br>`double` (before `foo`): The method returns a double.<br></br> `double` (before x, y, and z): The parameters x, y, and z are iouble values.
